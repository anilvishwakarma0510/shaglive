                ...
                <div class="col-md-12">
                        <div class="blog-item">
                            <div class="position-relative overflow-hidden rounded-top">
                                <img class="img-fluid" src="img/sign-up.jpg" alt="" width="100%">
                            </div>
                 ...
                 <div class="row mt-3 mb-3 p-4 sign-con">
                     <div class="col-lg-4 text-center">
                         <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center mb-3 m-auto" style="width: 60px; height: 60px;">
                            <i class="fa fa-star fs-4" style="color: #fff;"></i>
                        </div>
                        <div class="col-lg-12">
                                <a class="btn btn-primary w-100" href="account-detail.php">Create</a>
                            </div>
                     </div>
                     <div class="col-lg-4 text-center">
                         <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center mb-3 m-auto" style="width: 60px; height: 60px;">
                        ...
                        <div class="col-lg-12">
                                <a class="btn btn-primary w-100" href="account-detail.php">Go Live</a>
                            </div>
                     </div>
                     <div class="col-lg-4 text-center">
                         <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center mb-3 m-auto" style="width: 60px; height: 60px;">
                        ...
                        <div class="col-lg-12">
                                <a class="btn btn-primary w-100 " href="account-detail.php">Earn Money</a>
                            </div>
                     </div>
                 </div>
            </div>
                    ...
                    <form>
                        <div class="row g-3">
                            <div class="col-lg-12">
                                ...
                                <input type="file" class="form-control bg-light border-0 pt-2 mt-3" placeholder="Username">
                            </div>
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-12">
                                <a class="btn btn-primary w-100" href="m-dashboard.php">Create Free Account</a>
                            </div>
