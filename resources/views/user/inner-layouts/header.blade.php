<nav class="sb-topnav navbar navbar-expand navbar-dark sb-sidenav-dark p-1">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="index.php"><img src="{{ asset('img/logo.png') }}" width="150px;"></a>
    <!-- Sidebar Toggle-->
    <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" href="#!"><i class="fas fa-bars"></i></button>
    <a onclick="alert('coming soon'); return false" href="single-model.php" class="btn btn-light ms-auto p-0 ps-2 pe-2" >Go <img src="{{ asset('img/live.gif')}}" width="60px;" ></a>
    <!-- Navbar Search-->
