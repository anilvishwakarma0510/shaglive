...
<nav class="navbar navbar-expand-lg navbar-light bg-red">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php"><img src="img/logo.png" width="160px;"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 lef-menu">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#">Couples</a>
        </li> 
        <li class="nav-item">
      ...
      <ul class="d-flex navbar-nav">
        ...
        <li class="nav-item modal-login">
          <a class="nav-link" aria-current="page" href="model-sign-up.php">Become a Model</a>
        </li>
            ...
            <div class="col-lg-9">
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0 px-lg-5">
                    <a href="index.html" class="navbar-brand d-block d-lg-none">
                        <h1 class="m-0 display-4 text-primary text-uppercase"><img src="img/logo.png" width="200px;"></h1>
                    </a>
