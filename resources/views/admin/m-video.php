                    ...
                    <div class="container-fluid px-4">
                      <div class="row">
                          ...
                          <div class="col-sm-6 text-end pt-3">
                            <a href="upload-video.php" class="btn btn-primary"> Upload Video</a>
                          </div>
                      </div>
                        <div class="row">
                           <div class="col-sm-3 mb-3 fav">
                             <a href="m-single-video.php">
                                 <div class="pb-2 pt-2 bg-secondary p-2 edt-dlt-main" >
                                   <video width="100%" controls>
                                    <source src="video/s-vdo.mp4" type="video/mp4">
                                    </video>
                                   <div class="pt-1 text-white" >
                                     <b>BLONDE BABE GOT .....</b>
                                   </div>
                                   <p class="mb-0 d-flexk mt-1 edt-dlt" >
                                     <a href="upload-video.php" class="btn btn-light">
