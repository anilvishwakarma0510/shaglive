 ...
 <div id="layoutSidenav_content" class="bg-dark">
                ...
                <main class="" >
                    <div class="container-fluid px-4">
                        ...
                        <h3 class="mt-3 text-white page-ttl pb-3 mb-4">Active Model</h3>
                                          ...
                                          if($data){
                                            ...
                                            foreach($data as $data_val){
                                              ...
                                              <tr><td>{{$cnt}}</td>
                                                ...
                                                <td><button class="btn btn-primary btn-sm editEventModal" data-bs-toggle="modal" data-bs-target="#editEventModal<?php echo $data_val->id; ?>">View</button> </td>
                                              </tr>
