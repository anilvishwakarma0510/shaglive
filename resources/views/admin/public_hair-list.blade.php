 ...
 <div id="layoutSidenav_content" class="bg-dark">
                ...
                <main class="" >
                    <div class="container-fluid px-4">
                        ...
                        <h3 class="mt-3 text-white page-ttl pb-3 mb-4">Public Hair</h3>
                                             ...
                                             <tr>
                                              <td>{{$cnt}}</td>
                                                <td>{{$data_val->title}}</td>
                                                 <td><button class="btn btn-primary btn-xs editEventModal" data-bs-toggle="modal" data-bs-target="#editEventModal<?php echo $data_val->id; ?>">Edit</button>  <a href="{{url('admin/delete-public-hair?id='.$data_val->id)}}" onclick="return confirm('Are you sure?');" class="btn btn-sm btn-info">Delete</a></td>
                                             </tr>
...
<script type="text/javascript">
  ...
  function addCategory() {
    ...
    $('.alert-danger').remove();
        ...
        $.ajax({
              url: "{{route('admin.add-public-hair')}}",
              data: data,
              processData: false,
              contentType: false,
              type: 'POST',
  ...
  function editCategory(el, event, id) {
    ...
    $.ajax({
        url: "{{route('admin.edit-public-hair')}}",
        data: data,
        processData: false,
        contentType: false,
        type: 'POST',
