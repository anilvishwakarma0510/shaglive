 ...
 <div id="layoutSidenav_content" class="bg-dark">
                ...
                <main class="" >
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <h3 class="mt-3 text-white page-ttl pb-3 mb-4">Weight</h3>
                                        ...
                                        <tbody>
                                          ...
                                          if($data){
                                            ...
                                            foreach ($data as  $data_val) {
                                             ...
                                             <tr>
                                              <td>{{$cnt}}</td>
                                                <td>{{$data_val->in_ibs}}</td>
                                                <td>{{$data_val->in_kg}}</td>
                                                 <td><button class="btn btn-primary btn-xs editEventModal" data-bs-toggle="modal" data-bs-target="#editEventModal<?php echo $data_val->id; ?>">Edit</button> <a href="{{url('admin/delete-weight?id='.$data_val->id)}}" onclick="return confirm('Are you sure?');" class="btn btn-sm btn-info">Delete</a></td>
                                             </tr>
                                                          ...
                                                          <div class="modal-body">   
                                                                  ...
                                                                  <div class="form-group">
                                                                    ...
                                                                    <input type="hidden" name="id" value="{{$data_val->id}}" >
                                                                      <input type="text"class="form-control" name="in_kg" value="{{$data_val->in_kg}}" required />
                                                                  </div> 
            ...
            <div class="modal-header">
              ...
              <div id="MessageErrAddEmp"></div>        
                ...
                <div class="modal-body">   
                        ...
                        <div class="form-group">
                          <label class="control-label">Weight(in kg)</label>
                            <input type="number" step="0.01" class="form-control" name="in_kg" required />
                        </div> 
